...
class ClientAdapter(private val list: List<OrderModel>) :
    ...
    class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        val textView1: TextView = itemView.findViewById(R.id.clientOrderNameTextView)
        val textView2: TextView = itemView.findViewById(R.id.clientOrderDetailsTextView)
    }
}